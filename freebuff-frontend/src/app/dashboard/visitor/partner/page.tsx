...
import { Handshake, MapPin, Clock, Shield, Navigation, Phone } from 'lucide-react';

const visitInfo = {
  host: 'Mr. Ahmed Benali',
  department: 'Management',
  purpose: 'Partnership Review Meeting',
  checkIn: '10:00 AM',
  badge: 'VIS-2024-0855',
  floor: '5th Floor, Board Room',
};

const siteLocations = [
  { name: 'Main Reception', type: 'check-in', visited: true },
  { name: 'Cafeteria', type: 'facility', visited: false },
  { name: 'Board Room', type: 'destination', visited: false },
  { name: 'Parking Area', type: 'facility', visited: true },
];

const safetyRules = [
  'Always wear your partner badge',
  'Follow escort guidelines in restricted areas',
  'No photography without permission',
  'Report any safety concerns immediately',
];

export default function PartnerVisitorPage() {
  return (
    <DashboardLayout title="Partner Dashboard">
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-red-500 to-red-700 rounded-xl p-6 text-white">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="font-semibold flex items-center gap-2 mb-4">
            <Handshake className="w-5 h-5 text-red-600" /> Your Visit Details
          </h3>
