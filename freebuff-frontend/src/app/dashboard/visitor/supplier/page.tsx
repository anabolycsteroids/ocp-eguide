...
import { Package, MapPin, Clock, Shield, Navigation, Phone } from 'lucide-react';

const visitInfo = {
  host: 'Mr. Karim Idrissi',
  department: 'Operations',
  purpose: 'Supply Inspection',
  checkIn: '08:30 AM',
  badge: 'VIS-2024-0860',
  floor: 'Warehouse B, Loading Dock',
};

const siteLocations = [
  { name: 'Main Gate', type: 'check-in', visited: true },
  { name: 'Warehouse B', type: 'destination', visited: false },
  { name: 'Loading Dock', type: 'facility', visited: false },
  { name: 'Cafeteria', type: 'facility', visited: false },
];

const safetyRules = [
  'Always wear your supplier badge',
  'Follow designated supplier routes',
  'Wear safety vest in warehouse areas',
  'Report any safety concerns immediately',
];

export default function SupplierVisitorPage() {
  return (
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-red-600 to-red-800 rounded-xl p-6 text-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold">Welcome, Supplier! 📦</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="font-semibold flex items-center gap-2 mb-4">
            <Package className="w-5 h-5 text-red-600" /> Your Visit Details
          </h3>
